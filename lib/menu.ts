export type Product={id:string;name:string;category:string;price:number;description:string;availability?:string};
export const products:Product[]=[
{id:'six',name:'Six de panquecitos',category:'Gancho',price:150,description:'6 panquecitos en recipiente con papel grado alimenticio.',availability:'Sobre pedido recomendado'},
